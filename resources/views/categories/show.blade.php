                ...
                <div class="px-6 py-4">
                    ...
                    <div class="flex items-center justify-between mt-1">
                        <p class="text-xl font-bold text-gray-900">
                            Prix : {{ number_format($menu->prix, 2, ',', ' ') }} CDF
                        </p>
                        ...
                        <form action="{{ route('cart.add') }}" method="POST">
                            ...
                            <button type="submit" class="px-4 py-2 bg-green-600 text-white rounded-full flex items-center space-x-2 hover:bg-green-700 transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
                                    <path d="M8 0a2 2 0 0 1 2 2v2h2a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1h2V2a2 2 0 0 1 2-2h2z"/>
                                </svg>
                                <span>Ajouter</span>
                            </button>
                        </form>
